...
//			    P2 ABC Seller
			...
			//p7	
				...
				Thread.sleep(3000);
				takeScreenshot("TQSCRPAY1");
				takeScreenshot("TQSCRPAY2");
				takeScreenshot("TQSCRPAY3");
				takeScreenshot("TQSCRPAY4");
				takeScreenshot("TQSCRPAY5");
				takeScreenshot("TQSCRPAY6");
				takeScreenshot("TQSCRPAY7");
				takeScreenshot("TQSCRPAY8");
				takeScreenshot("TQSCRPAY9");
				takeScreenshot("TQSCRPAY10");
