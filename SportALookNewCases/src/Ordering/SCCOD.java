...
//			    P2 ABC Seller
			...
			//p7	
				...
				Thread.sleep(1000);
				takeScreenshot("TQsccodpage1");
				takeScreenshot("TQsccodpage2");
				takeScreenshot("TQsccodpage3");
				takeScreenshot("TQsccodpage4");
				takeScreenshot("TQsccodpage5");
				takeScreenshot("TQsccodpage6");
				takeScreenshot("TQsccodpage7");
				takeScreenshot("TQsccodpage8");
				takeScreenshot("TQsccodpage9");
				takeScreenshot("TQsccodpage10");
