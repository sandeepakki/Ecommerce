...
//			    P2 ABC Seller
			...
			//p7	
				...
				Thread.sleep(3000);
				takeScreenshot("RpayLPpage");
				Thread.sleep(5000);
				takeScreenshot("TQRPAYLP1");
				takeScreenshot("TQCODLP2");
				takeScreenshot("TQCODLP3");
				takeScreenshot("TQCODLP4");
				takeScreenshot("TQCODLP5");
				takeScreenshot("TQCODLP6");
				takeScreenshot("TQCODLP7");
				takeScreenshot("TQCODLP8");
				takeScreenshot("TQCODLP9");
				takeScreenshot("TQCODLP10");
