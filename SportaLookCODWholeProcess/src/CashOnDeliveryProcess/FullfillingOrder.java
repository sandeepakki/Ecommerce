...
public void adminDeliveryConfirm() {
	...
	for(int i=0;i<=1;i++) {
		if(i==0) {
	driver.findElement(By.xpath("//a[@href ='orderupdate.aspx?id=2171-S1162019&pid=0']/img[@title='MANAGE ORDER']")).click();
	...
	driver.findElement(By.linkText("Submit")).click();
			...
			driver.findElement(By.xpath("//a[@href ='orderupdate.aspx?id=2172-S1162019&pid=0']/img[@title='MANAGE ORDER']")).click();
