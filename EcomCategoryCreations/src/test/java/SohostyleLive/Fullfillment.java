...
public class Fullfillment extends BaseClass {
	...
	public void testSellerFullfillment() throws InterruptedException, AWTException, IOException {
		...
		Thread.sleep(3000);
//		for(int a=0;a<=3;a++) {
//		driver.navigate().to("https://seller.sohostyle.in/suppliermyaccount/pending");
//try {
...
//		}
	//Ready to ship all the confirmed order
		for(int b=0;b<=3;b++) {
driver.navigate().to("https://seller.sohostyle.in/suppliermyaccount/confirm");
			try{
			...
			//	driver.findElement(By.id("txtshippingweight")).sendKeys("1000");
				Thread.sleep(5000);
				driver.findElement(By.id("txt_awbn_no")).sendKeys("SANIJ123");
				Thread.sleep(2000);
				driver.findElement(By.linkText("Submit")).click();
...
//Manage order- click here to download manifest -- upload manifest
 ...
 public void Screenshot() throws InterruptedException {
	  ...
	  WebElement element =	driver.findElement(By.xpath("//li[@id='liSales_parent']/a"));
		...
		driver.findElement(By.xpath("//a[@href ='orderupdate.aspx?id=237-S1764929&pid=0']/img[@title='MANAGE ORDER']")).click();
